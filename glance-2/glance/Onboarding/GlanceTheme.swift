...
enum GlanceTheme {
    private static let accentRGB = (r: 0x34 / 255.0, g: 0xC7 / 255.0, b: 0x59 / 255.0)
    ...
    static let accentPale   = Color(red: 0xCF / 255, green: 0xFF / 255, blue: 0xDA / 255)
    static let accentBright = Color(red: 0x7F / 255, green: 0xE0 / 255, blue: 0x99 / 255)
    static let accentDeep   = Color(red: 0x1F / 255, green: 0x8A / 255, blue: 0x3D / 255)
    ...
    static let badgeYourFace = [Color(red: 0x71 / 255, green: 0xE8 / 255, blue: 0x99 / 255), // top: light green
                                Color(red: 0x25 / 255, green: 0xA8 / 255, blue: 0x54 / 255)]// bottom: green
